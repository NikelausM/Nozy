		...
		<div class="row h-75 align-items-center">
			<div style="top: 20%;" class="col-12">
				...
				@if(Auth::guard('profile')->user()->id == $community->manager_user_id)
					<div style="padding-bottom:10px"> @include('community.edit_community_profile_form')</div><!-- this messes up page when it expands to show edit menu-->
					<div>@include('community.delete_community_button')</div>
				@endif
				<br><br>
