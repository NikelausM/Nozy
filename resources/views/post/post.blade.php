	...
	<div class="container h-100">
		...
		<div class="row h-75 align-items-center">
			<div style="top: 20%;" class="col-12">
				<h1 class="font-weight-bold">Post: {{$post->title}}</h1>
				<p class="font-weight-bold">Rating: {{$post->rating}}</p>
				<p class="font-weight-bold">Description: {{$post->description}}</p>
				...
				<div class="row" style="padding: 10px"><!--row-->
					...
					<div class="col-sm-6 col-md-4"><!--column-->
						<div class="thumbnail shadow">
							<h3><font color="black">Comment description: <!--{{ $comment->description }}--></font></h3>
							<div class="caption">
								<p><font color="black">Comment rating: <!--{{ $post->rating }}--></font></p>
								<div>
								</div>
							</div>
						</div>
