...
<?php $user_posting_comment = \App\User::where('profile_id', Auth::guard('profile')->user()->id)->first();?>
  ...
  <div class="container">
    ...
    @if(Session::has("store_comment_error_".Session::get('unique_id')))
    <?php $store_comment_error_id = Session::get("store_comment_error_".Session::get('unique_id')) ?>
    <div class="alert alert-danger"><font color = "red"><?php echo nl2br($store_comment_error_id);?></font></div>
    <?php Session::forget($store_comment_error_id) ?>
